...
ifeq ($(CONFIG_EXTERNAL_TOOLCHAIN),)
  ...
  REAL_GNU_TARGET_NAME=$(OPTIMIZE_FOR_CPU)-librecmc-linux$(if $(TARGET_SUFFIX),-$(TARGET_SUFFIX))
  GNU_TARGET_NAME=$(OPTIMIZE_FOR_CPU)-librecmc-linux
...
ifndef DUMP
  ifeq ($(CONFIG_EXTERNAL_TOOLCHAIN),)
    ...
    TARGET_CROSS:=$(if $(TARGET_CROSS),$(TARGET_CROSS),$(OPTIMIZE_FOR_CPU)-librecmc-linux$(if $(TARGET_SUFFIX),-$(TARGET_SUFFIX))-)
...
NINJA = \
	...
	$(STAGING_DIR_HOST)/bin/ninja \
		$(if $(findstring c,$(LIBRECMC_VERBOSE)),-v) \
