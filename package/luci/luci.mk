...
LUCI_SECTION?=luci
LUCI_CATEGORY?=LuCI
LUCI_URL?=https://github.com/librecmc/luci
LUCI_MAINTAINER?=libreCMC LuCI community
LUCI_MINIFY_LUA?=1
LUCI_MINIFY_CSS?=1
LUCI_MINIFY_JS?=1
...
# LUCI_SUBMENU: the submenu-item below the LuCI top-level menu inside libreCMC menuconfig
