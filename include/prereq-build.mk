...
$(eval $(call TestHostCommand,perl-time-piece, \
        Please install the Perl Time::Piece module, \
        perl -MTime::Piece -e 1))

$(eval $(call TestHostCommand,perl-json-pp, \
        Please install the Perl JSON::PP module, \
        perl -MJSON::PP -e 1))
